...
//button
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = LexxyOFC.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "𝑴𝑬𝑵𝑼","footerText": `Sc By King Of Bear Botz`,"listType": "SINGLE_SELECT","sections": list}}, {})
...
LexxyOFC.sendMessage(from, ini, image, { quoted: mek, caption: '𝑸𝒖𝒐𝒕𝒆𝒔 𝑩𝒚 𝙆𝙞𝙣𝙜 𝙊𝙛 𝘽𝙚𝙖𝙧' })
break
case 'quotesid':
case 'quotes':
reply(mess.wait)
...
┗━━━━━━━━━━━━━
━➤ 「 𝙄𝙉𝙁𝙊 𝘿𝙀𝙑 」
✍️ 𝑆𝑐𝑟𝑖𝑝𝑡 𝑀𝑎𝑑𝑒 𝑖𝑛 𝐵𝑦 𝓚𝓲𝓷𝓰 𝓞𝓯 𝓑𝓮𝓪𝓻
🌟 𝑉𝑒𝑟𝑠𝑖𝑜𝑛 : 6.0
📈 𝐿𝑎𝑠𝑡 𝑈𝑝𝑑𝑎𝑡𝑒 : 01-Jan-2022
